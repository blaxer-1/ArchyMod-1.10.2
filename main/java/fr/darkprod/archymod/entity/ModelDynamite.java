  ...
  extends ReforgedModel
{
  ...
  public ModelDynamite()
  {
    ...
    setRotateAngle(this.Fire, 0.4553564F, 0.0F, 0.0F);
  ...
  public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
  {
    ...
    GlStateManager.translate(this.Fire.rotationPointX * f5, this.Fire.rotationPointY * f5, this.Fire.rotationPointZ * f5);
    ...
    GlStateManager.translate(this.Dynamite.rotationPointX * f5, this.Dynamite.rotationPointY * f5, this.Dynamite.rotationPointZ * f5);
